...
orphans_runtime_false = [f for f in orphans if combined[f]['runtime_importable'] is False]
orphans_runtime_unknown = [f for f in orphans if combined[f]['runtime_importable'] is None]
