...
PIPELINE_STUBS = {
    "pendant": ["acquisition", "edge_detection", "geometry", "optimization", "outputs", "overlay", "physics", "preprocessing", "scaling", "solver", "validation", "drawing", "metrics"],
    "sessile": ["acquisition", "edge_detection", "geometry", "optimization", "outputs", "overlay", "physics", "preprocessing", "scaling", "solver", "validation", "drawing", "metrics"],
    "capillary_rise": ["acquisition", "edge_detection", "geometry", "optimization", "outputs", "overlay", "physics", "preprocessing", "scaling", "solver", "validation"],
    "oscillating": ["acquisition", "edge_detection", "geometry", "optimization", "outputs", "overlay", "physics", "preprocessing", "scaling", "solver", "validation"],
    "captive_bubble": ["acquisition", "edge_detection", "geometry", "optimization", "outputs", "overlay", "physics", "preprocessing", "scaling", "solver", "validation"],
}
