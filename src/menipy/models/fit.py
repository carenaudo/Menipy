...
class FitConfig:
    ...
    def to_solver_args(self) -> dict:
        ...
        return {
            "x0": self.x0, "bounds": self.bounds, "loss": self.loss, "f_scale": self.f_scale,
            "max_nfev": self.max_nfev, "verbose": self.verbose, "distance": self.distance,
            "weights": self.weights, "param_names": self.param_names,
        }