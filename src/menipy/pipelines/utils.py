...
def ensure_contour(ctx: Context, settings: Optional[EdgeDetectionSettings] = None) -> np.ndarray:
    """
    ...
    run_settings = settings or ctx.edge_detection_settings or EdgeDetectionSettings(method="canny")
