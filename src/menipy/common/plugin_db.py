...
class PluginDB:
    ...
    def upsert_pipeline_metadata(self, *, pipeline_name: str, display_name: str,
        ...
        calibration_json = json.dumps(calibration_params) if calibration_params else None
        ...
        with self.connect() as con:
            ...
            ON CONFLICT(pipeline_name) DO UPDATE SET
              ...
              updated_at=CURRENT_TIMESTAMP;
            """, (pipeline_name, display_name, icon, color, stages_json, calibration_json, primary_metrics_json))
    ...
    def get_pipeline_metadata(self, pipeline_name: str) -> Optional[dict]:
        ...
        with self.connect() as con:
            ...
            display_name, icon, color, stages_json, calibration_json, primary_metrics_json = row
    ...
    def list_pipeline_metadata(self) -> list[dict]:
        ...
        with self.connect() as con:
            ...
            result = []
            for row in rows:
                pipeline_name, display_name, icon, color, stages_json, calibration_json, primary_metrics_json = row
